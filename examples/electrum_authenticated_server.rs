...
const DB_PATH: &str = "bdk-example-electrum-authenticated-server.sqlite";
...
fn main() -> Result<(), anyhow::Error> {
    ...
    println!("Connecting To Authenticated Electrum Server: {electrum_url}");
    let config = Config::builder().authorization_provider(Some(auth_provider)).build();
